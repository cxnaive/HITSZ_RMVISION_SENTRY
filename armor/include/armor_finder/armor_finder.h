...
class ArmorFinder {
   public:
    ArmorFinder(RmRunTime* _runtime,RmSerial * _serial);
    ~ArmorFinder() = default;
   ...
   private:
    ...
    bool sendTarget(RmSerial* serial, double x, double y, double z,
